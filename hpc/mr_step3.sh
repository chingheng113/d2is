...
labelconvert ./6946_reconall/mri/aparc+aseg.mgz $FREESURFER_HOME/FreeSurferColorLUT.txt ../mrtrix3/share/mrtrix3/labelconvert/fs_default.txt 6946_parcels.mif
